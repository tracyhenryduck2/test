...
public class Common {
	...
	public static Long TimeStrToLong(String date){
		try {
			return TIME_FORMAT.parse(date).getTime()/1000;
	...
	public static String TimeLongToStr(Long date){
		if(date!=null){
			return TIME_FORMAT.format(date*1000);
		}else{
			return null;
		}
	}
