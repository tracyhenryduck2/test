...
<html>    
  ...
  <body>  
  <GF:BodyCaption label="功能组" ico="images/ico/user.gif"> 
  	<GF:ToolBar id="123">     
    ...
    <form action="<%=path%>/system/SFunctionGroup!list.action" name="form1" id="form1" method="get">  
			...
			<input type="hidden" name="sFunctionGroupBean.sortId" id="sortId" value="${sFunctionGroupBean.sortId}"/> 
			...
			<table id="table1" width="100%" height="100%"  border="0" cellspacing="0" cellpadding="0"> 
			   	 <thead>
			   		<tr>  
			   			...
			   			<th sortname="name" width="50%">名称</th>	   
			   			<th sortname="sort_id" width="50%">排序</th>	   
			   		</tr> 
			   	</thead>
			   	<tbody> 
