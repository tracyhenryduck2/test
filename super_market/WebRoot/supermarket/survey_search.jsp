...
<table cellpadding="0" cellspacing="0" width="100%" class="GF-grid"> 
  <tr>                                    
        ...
        <td>                             
            <input type="text" name="surveyBean.name" id="name"  value="${surveyBean.name}" class="GF-field"/>   
        </td>                            
  </tr>                                
  <tr>                                    
    	<td align="right" width="30%" > 
        ...
        <td>                             
            <input type="text" name="surveyBean.createTime" id="createTime"  value="${surveyBean.createTime}" class="GF-field"/>   
        </td>                            
  </tr>                                
  <tr>                                    
    	<td align="right" width="30%" > 
